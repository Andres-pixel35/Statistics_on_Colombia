...
```bash
~/Documents/coding/genius/colombia/data/original/datos_abiertos/Entradas_de_extranjeros_a_Colombia_20260520.csv
```
...
```bash
~/Documents/coding/genius/colombia/data/original/datos_abiertos/Salidas_de_colombianos_desde_el_territorio_nacional_20260520.csv
``` 
...
```bash
/home/riosandres/Documents/coding/genius/colombia/data/original/world_bank/net_migration.xls
```
...
```bash
/home/riosandres/Documents/coding/genius/colombia/data/original/dane/borns/year # being year 2026 or 2027 or whatever
```
...
```bash
/home/riosandres/Documents/coding/genius/colombia/data/original/dane/deaths/year # being year 2026 or 2027 or whatever
```
...
```bash
/home/riosandres/Documents/coding/genius/colombia/data/original/dane/population/departamental/YYYY-YYYY
```
...
```bash
/home/riosandres/Documents/coding/genius/colombia/data/original/dane/population/nacional/YYYY-YYYY
```
...
```bash
/home/riosandres/Documents/coding/genius/colombia/data/original/dane/population/municipal/YYYY-YYYY
```
