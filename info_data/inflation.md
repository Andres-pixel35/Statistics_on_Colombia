...
```bash
/path/to/the/repo/colombia/data/original/banco_republica/CPI/inflacion_15.xlsx 
```
...
```bash
/path/to/the/repo/colombia/data/original/banco_republica/CPI/1_IPC_2018_por_ciudad_iqy.xlsx 
```
...
```bash
/path/to/the/repo/colombia/data/original/banco_republica/CPI/2_IPC_2018_por_division_de_gasto_iqy.xlsx 
```
...
```bash
/path/to/the/repo/colombia/data/original/banco_republica/CPI/inflacion_20.xlsx 
```
...
```bash
/path/to/the/repo/colombia/data/original/banco_republica/CPI/goal.xlsx 
```
...
```bash
/path/to/the/repo/colombia/data/banco_republica/CPI/inflacion_15.csv
```
...
Now store it as a csv at
```bash
/path/to/the/repo/colombia/data/banco_republica/CPI/inflacion_20.csv
```
...
Now store it as a csv at
```bash
/path/to/the/repo/colombia/data/banco_republica/CPI/goal.csv
```
