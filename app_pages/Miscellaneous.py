...
from app_pages.tabs.miscellaneous import exchange_rate, monetary_policy_rate, minimum_wage, lending_rate, misery_rate
from app_pages.helpers.macro.gdp_functions import gdp_per_capita_growth
