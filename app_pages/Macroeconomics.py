...
from app_pages.tabs.macroeconomics import gdp, cpi, job_market, productivity, debt, deficit, ise
...
with st.sidebar:
    section = st.radio(t("Section:"), ["GDP", "CPI", "Job Market", "Productivity", "Debt", "Deficit", "ISE"], format_func=t)
